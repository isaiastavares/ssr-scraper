...
// item list object
itemList['description'] = document.querySelector('.heading-h3.buyers-guide-heading.text-align-center').innerHTML
...
document.querySelectorAll('.ssr-bg-topdetails-content').forEach(vendor => {
    ...
    let vendorUrl = vendor.querySelector('.ssr-toplist-item-burton-holder > a').href
